...
def get_test_data(test_path):
    ...
    with open(test_path, 'r', encoding='utf-8') as f:
        ...
        for l in f:
            ...
            datas.append((text1_op_ed, text2_op_ed, str(data['id'])))
...
# 分类器1
    ...
    # 转换数据集
    test_generator_1 = data_generator(test_data, batch_size)
    ...
    test_sents_r_1 = get_sents_represent(test_generator_1, len(test_data), cls_layer_1)
    res_1 = n_model_1.predict(test_sents_r_1)
...
# 分类器2
    ...
    # 转换数据集
    test_generator_2 = data_generator(test_data, batch_size)
    ...
    test_sents_r_2 = get_sents_represent(test_generator_2, len(test_data), cls_layer_2)
    res_2 = n_model_2.predict(test_sents_r_2)
...
# 分类器3
    ...
    # 转换数据集
    test_generator_3 = data_generator(test_data, batch_size)
    ...
    test_sents_r_3 = get_sents_represent(test_generator_3, len(test_data), cls_layer_3)
    res_3 = n_model_3.predict(test_sents_r_3)
    n_res_3 = np.argmax(res_3, axis=-1)


# 对三个结果投票
    test_sents_r = keras.layers.concatenate([n_res_1, n_res_2, n_res_3], axis=-1)
    n_model_stacking = load_model('final_model.h5')
    res = n_model_stacking.predict(test_sents_r)
