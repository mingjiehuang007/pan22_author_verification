...
config_path = r'D:\NLP\models\BERT\electra_base\electra_config.json'
checkpoint_path = r'D:\NLP\models\BERT\electra_base\electra_base'
dict_path = r'D:\NLP\models\BERT\electra_base\vocab.txt'
...
model.load_weights('checkpoint2/best_model.weights')  #加载微调后的权重
...
def get_sents_represent(generator, texts_num):
    ...
    sents_rs = sents_r.reshape(texts_num, 4, 768)
...
np.save("checkpoint2/train_sents_rs.npy",train_sents_rs)
np.save("checkpoint2/test_sents_rs.npy",test_sents_rs)
