...
def get_sents_represent(generator, texts_num, cls_layer):
    sents_r = np.array([])
...
config_path_1 = r'D:\NLP\models\BERT\cased_L-12_H-768_A-12\bert_config.json'
checkpoint_path_1 = r'D:\NLP\models\BERT\cased_L-12_H-768_A-12\bert_model.ckpt'
dict_path_1 = r'D:\NLP\models\BERT\cased_L-12_H-768_A-12\vocab.txt'

config_path_2 = r'D:\NLP\models\BERT\electra_base\electra_config.json'
checkpoint_path_2 = r'D:\NLP\models\BERT\electra_base\electra_base'
dict_path_2 = r'D:\NLP\models\BERT\electra_base\vocab.txt'

config_path_3 = r'D:\NLP\models\BERT\electra_small\electra_config.json'
checkpoint_path_3 = r'D:\NLP\models\BERT\electra_small\electra_small'
dict_path_3 = r'D:\NLP\models\BERT\electra_small\vocab.txt'


# 分类器1
tokenizer = Tokenizer(dict_path_1, do_lower_case=False)
...
# 转换数据集
train_generator_1 = data_generator(data[:train_data_len], batch_size)
valid_generator_1 = data_generator(data[train_data_len:], batch_size)

model_1 = build_bert_model_1(config_path_1, checkpoint_path_1)
model_1.load_weights('checkpoint1/best_model.weights')
cls_layer_1 = Model(inputs=model_1.input, outputs=model_1.layers[-3].output)
n_model_1 = load_model('checkpoint1/final_model.h5')
train_sents_r_1 = get_sents_represent(train_generator_1, len(data[:train_data_len]), cls_layer_1)
valid_sents_r_1 = get_sents_represent(valid_generator_1, len(data[train_data_len:]), cls_layer_1)
train_res_1 = n_model_1.predict(train_sents_r_1)
valid_res_1 = n_model_1.predict(valid_sents_r_1)

train_n_res_1 = np.argmax(train_res_1, axis=-1)
valid_n_res_1 = np.argmax(valid_res_1, axis=-1)



# 分类器2
tokenizer = Tokenizer(dict_path_2, do_lower_case=True)
...
# 转换数据集
train_generator_2 = data_generator(data[:train_data_len], batch_size)
valid_generator_2 = data_generator(data[train_data_len:], batch_size)

model_2 = build_bert_model_2(config_path_2, checkpoint_path_2)
...
n_model_2 = load_model('checkpoint2/final_model.h5')
train_sents_r_2 = get_sents_represent(train_generator_2, len(data[:train_data_len]), cls_layer_2)
valid_sents_r_2 = get_sents_represent(valid_generator_2, len(data[train_data_len:]), cls_layer_2)
train_res_2 = n_model_2.predict(train_sents_r_2)
valid_res_2 = n_model_2.predict(valid_sents_r_2)

train_n_res_2 = np.argmax(train_res_2, axis=-1)
valid_n_res_2 = np.argmax(valid_res_2, axis=-1)
...
# 分类器3
tokenizer = Tokenizer(dict_path_3, do_lower_case=True)
...
# 转换数据集
train_generator_3 = data_generator(data[:train_data_len], batch_size)
valid_generator_3 = data_generator(data[train_data_len:], batch_size)

model_3 = build_bert_model_3(config_path_3, checkpoint_path_3, class_nums=2)
model_3.load_weights('checkpoint3/best_model.weights')
cls_layer_3 = Model(inputs=model_3.input, outputs=model_3.layers[-2].output)
n_model_3 = load_model('checkpoint3/final_model.h5')
train_sents_r_3 = get_sents_represent(train_generator_3, len(data[:train_data_len]), cls_layer_3)
valid_sents_r_3 = get_sents_represent(valid_generator_3, len(data[train_data_len:]), cls_layer_3)
train_res_3 = n_model_3.predict(train_sents_r_3)
valid_res_3 = n_model_3.predict(valid_sents_r_3)

train_n_res_3 = np.argmax(train_res_3, axis=-1)
valid_n_res_3 = np.argmax(valid_res_3, axis=-1)


train_sents_r = keras.layers.concatenate([train_n_res_1, train_n_res_2, train_n_res_3], axis=-1)
valid_sents_r = keras.layers.concatenate([valid_n_res_1, valid_n_res_2, valid_n_res_3], axis=-1)
